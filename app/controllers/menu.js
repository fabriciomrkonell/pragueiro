(function(){
	...
	angular.module('Pragueiro.controllers').registerCtrl('menuCtrl', menuCtrl);

	menuCtrl.$inject = ['$scope', '$firebaseArray', '$firebaseObject', 'Session', 'Constant', 'Notify'];

	function menuCtrl($scope, $firebaseArray, $firebaseObject, Session, Constant, Notify) {
